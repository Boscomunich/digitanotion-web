...
function Hero() {
  return (
    <div>
      <section className="relative overflow-hidden bg-white poppins-semibold max-w-8xl">
        <div
          aria-hidden="true"
        ...
        <div className="mx-auto px-4 lg:px-8 min-h-[90vh] flex flex-col justify-center max-w-[1500px]">
          <div className="grid gap-10 lg:grid-cols-2 min-h-[60vh] lg:min-h-[70vh] items-center place-items-center">
            <div className="flex flex-col items-start max-w-3xl mx-auto text-left">
              ...
              <div className="mt-6 flex flex-col md:flex-row flex-wrap justify-start gap-2">
        ...
        <div className="grid gap-6 sm:grid-cols-3 my-8 px-4 lg:px-8 max-w-7xl mx-auto">
