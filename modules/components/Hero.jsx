...
function Hero() {
  ...
  <div className="grid gap-10 lg:grid-cols-2 min-h-[60vh] lg:min-h-[70vh] items-center place-items-center">
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
          ...
          <p className="mt-4 max-w-2xl text-base leading-relaxed text-neutral-600 sm:text-lg ">
            Digitanotion Limited is your go-to partner for <span className="font-semibold text-neutral-900">cybersecurity</span>,
            <span className="font-semibold text-neutral-900">software development</span>, and
            <span className="font-semibold text-neutral-900"> digital skills training</span>.
            We turn cutting-edge ideas into secure, practical solutions for real businesses. Whether we're
            building mobile apps and websites or fortifying cyber defenses, our services are tailored to your needs.
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
            ...
            >
             Start a Project on WhatsApp
              <svg className="ml-2 h-4 w-4 transition group-hover:translate-x-0.5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
        ...
        <div className="hidden lg:flex items-center justify-center w-full">
          ...
          >
            ...
            <div className="pointer-events-none absolute -right-4 -bottom-5 select-none">
              <span className="inline-flex items-center rounded-lg border border-red-200 bg-red-50 px-3 py-1 text-xs font-semibold text-red-700">Secured Products</span>
            </div>
          </div>
        </div>
      </div>
  ...
  <div className="grid gap-6 sm:grid-cols-3 mt-8">
      <div className="rounded-2xl border border-neutral-200 bg-white p-5 text-center shadow-sm">
        <div className="text-3xl font-extrabold text-neutral-900">Power</div>
        <div className="mt-1 text-sm text-neutral-600">Up to 99.9% API Uptime on Render</div>
      </div>
      <div className="rounded-2xl border border-neutral-200 bg-white p-5 text-center shadow-sm">
        <div className="text-3xl font-extrabold text-neutral-900">Product</div>
        <div className="mt-1 text-sm text-neutral-600">Product-first UIs built for real-world impact</div>
      </div>
      <div className="rounded-2xl border border-neutral-200 bg-white p-5 text-center shadow-sm">
        <div className="text-3xl font-extrabold text-neutral-900">Performance</div>
        <div className="mt-1 text-sm text-neutral-600">Lighthouse-friendly builds</div>
      </div>
    </div>
  </section>
</div>
