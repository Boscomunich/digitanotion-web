        ...
        <div className="grid items-center gap-10 md:grid-cols-2">
          <div>
            ...
            <p className="mt-5 max-w-xl text-base md:text-lg text-stone-600">
              Digitanotion helps companies ship secure, resilient systems —
              faster. We handle architecture, deployments, and skills training
              so your team can focus on growth and customers.
            </p>

            <div className="mt-6 flex flex-wrap gap-3">
              <a
                href="/services"
                className="glass rounded-2xl px-5 py-3 text-sm font-semibold  shadow-lg hover:opacity-95 transition"
              >
                Start a Project
              </a>
            </div>
            ...
            >
              <GlassCard
                title="Who we are"
                text="Digitanotion Systems strives to provide the high quality technological solutions with a focus on production, re‑engineering and skill training."
              />
              <GlassCard
                title="Our Vision"
                text="To become the benchmark for IT excellence in Africa—driving progress through innovation and skill development."
              />
              <GlassCard
                title="Our Mission"
                text="Providing clients with innovative and efficient solutions; turning complex problems into simplified tech solutions."
              />
            </motion.div>
          </div>
...
function GlassCard({ title, text }) {
  return (
    <motion.div
      variants={itemVariant}
      className="glass p-4 rounded-2xl text-slate-950/90"
    >
  ...
  return (
    <div className="relative mx-auto w-full max-w-xl">
      <div
        ...
        style={{ background: "rgba(251,133,7,0.20)" }}
      />
      ...
      >
        <div
          ...
          style={{
            ...
            backgroundColor: "rgba(251,133,7,0.08)",
          }}
        >
          ...
          <div className="mt-4 grid grid-cols-5 gap-2">
            {Array.from({ length: 15 }).map((_, i) => (
              <motion.div
                ...
                style={{
                  height: `${52 + ((i * 11) % 56)}px`,
                  background:
                    "linear-gradient(180deg, rgba(251,133,7,0.75), rgba(251,133,7,0.25))",
                }}
              />
            ))}
          </div>
          ...
          <div className="mt-4 grid grid-cols-2 gap-2 text-xs text-white/95">
            {[
              ...
              <div key={t} className="glass px-3 py-2 rounded-lg">
                {t}
              </div>
            ))}
          </div>
