...
const imageUrls = {
  ...
  "mobile-dev": "https://res.cloudinary.com/dnitzkowt/image/upload/v1761139841/safar-safarov-LKsHwgzyk7c-unsplash_ofhryu.jpg",
  "pentest": "https://res.cloudinary.com/dnitzkowt/image/upload/v1761034195/clint-patterson-dYEuFB8KQJk-unsplash_w4fzrp.jpg",
  "media": "https://res.cloudinary.com/dnitzkowt/image/upload/v1761139686/emediong-umoh-HUvGioRvyhI-unsplash_njrnqk.jpg",
};
...
export const SERVICES = [
  {
    ...
    waMessage:
      "Hello, I would like to discuss your Software Development services for my business.",
  },
  {
    key: "web-design",
    name: "Web Designing",
    ...
    waMessage:
      "Hello, I would like to discuss your Web Designing services for a scalable website.",
  },
  {
    key: "automation",
    ...
    waMessage:
      "Hello, I would like to discuss your Business Automation services to reduce manual work.",
  },
  {
    key: "mobile-dev",
    ...
    waMessage:
      "Hello, I would like to discuss your Mobile App Development services for my product idea.",
  },
  {
    key: "pentest",
    ...
    waMessage:
      "Hello, I would like to discuss your Ethical Hacking (PenTesting) services to assess my system.",
  },
  {
    key: "media",
    ...
    waMessage:
      "Hello, I would like to discuss your Media Production services for marketing content.",
  },
];
