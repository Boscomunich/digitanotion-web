...
function Hero() {
	const registerText = encodeURIComponent(`
		I would like to express my interest in enrolling in the Web Development Course.
	...
	return (
		<div className="box-border flex flex-col gap-1 relative">
			...
			<h1 className="my-10 mx-5 md:mx-10 text-brand-text text-[40px] font-bold mb-4 z-5 md:w-180 md:text-[45px]">Web Development Specialization</h1>
			<div className="mb-10 mx-5 md:mx-10 z-5 flex flex-col md:flex-row gap-3 md:gap-6 md:justify-between md:items-center box-border">
